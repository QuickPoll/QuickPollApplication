...
public class QuickPollTabsConfig {
    public static QuickPollTabsConfig.TabInfo[] TABINFOS = {
            new QuickPollTabsConfig.TabInfo( "사용자", R.drawable.no_selected_question_image, R.drawable.questionimage, QuizListFragment.class, null),
            new QuickPollTabsConfig.TabInfo( "알람1", R.drawable.ranking_image, R.drawable.select_ranking_image, PercentFragment.class, null),
    };
