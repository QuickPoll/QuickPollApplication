...
public class QuickPollTabsConfig {
    public static QuickPollTabsConfig.TabInfo[] TABINFOS = {
            new QuickPollTabsConfig.TabInfo( "사용자", R.drawable.ic_online, R.drawable.ic_online, AdminNursesListFragment.class, null),
            new QuickPollTabsConfig.TabInfo( "알람1", R.drawable.ic_online, R.drawable.ic_online, AdminChatRoomListFragment.class, null),
    };
